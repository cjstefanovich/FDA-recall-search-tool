...
Where *q* is the query, *d* is the document, *$w_{t,q}$* is the TF-IDF weight of term *t* in the query, *$w_{t,d}$* is the TF-IDF weight of term *t* in the document, and *$q \cap d$* is terms appearing in both query and document. Therefore, the similarity of query *q* and document *d* is the sum over shared terms *t* of query weight times document weight, divided by the product of the query and document vector norms.
